...
import com.teamfis.app.ui.components.MySettingRow
...
fun MyScreen(onBack: () -> Unit) {
    ...
    Column(
        ...
        Column(
            ...
            MySectionHeader("설정", modifier = Modifier.padding(top = TeamFisSpacing.xxxl))
            Column(verticalArrangement = Arrangement.spacedBy(TeamFisSpacing.sm)) {
                // TODO: 알림 설정 · 로그아웃이 붙으면 연결한다
                MySettingRow("알림", onClick = {})
                MySettingRow("로그아웃", onClick = {}, danger = true)
            }
